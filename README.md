...
Design fascinates me, not the pretty colors and fancy animations, but the invisible stuff. How information moves, why users click what they click, how systems talk to each other without breaking. UI, backend architecture, database schemas it's all design. Even the ugly code no one sees.
